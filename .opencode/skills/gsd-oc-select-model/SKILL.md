...
description: Fluxo interativo de seleção de modelo com navegação paginada. Use quando o usuário quiser selecionar um modelo interativamente — guia o usuário pela seleção do provedor e depois do modelo usando a ferramenta de perguntas com suporte a paginação para listas grandes.
---
